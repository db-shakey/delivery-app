angular.module('dorrbell').config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider, $locationProvider, lazyImgConfigProvider) {
  ...
  lazyImgConfigProvider.setOptions({
    onError : function(image){
      ...
      image.$elem[0].src = missingDefault;
    },
    offset: 1000
  });
